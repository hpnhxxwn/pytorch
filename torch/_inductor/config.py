...
# Modifies the number of autotuning choices displayed, default is 10, set to None for all
autotune_num_choices_displayed = (
    None
    if (
        v := os.getenv("TORCHINDUCTOR_AUTOTUNE_NUM_CHOICES_DISPLAYED", "10").strip()
    ).upper()
    == "ALL"
    else int(v)
    if v.isdigit()
